    ...
    <div class="feature-content" data-aos="fade-down">
        <div class="box">
            ...
            <div class="f-text">
                ...
                <p>Nooit vooruitbetalen, altijd achteraf met Klarna - Shop nu, betaal later!</p>
            </div>
        </div>
        ...
        <div class="box">
            ...
            <div class="f-text">
                ...
                <p>Geen grenzen, geen extra kosten: Ontdek het gemak van gratis verzending voor een zorgeloze winkelervaring.</p>
            </div>
        </div>
        ...
        <div class="box">
            ...
            <div class="f-text">
                <h3>35 dagen zorgeloos retourneren</h3>
                <p>"Niet tevreden? Binnen 35 dagen terug, zonder gedoe!"</p>
            </div>
        </div>
